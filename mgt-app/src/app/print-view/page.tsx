      ...
      <div className="p-0 print:p-0 max-w-none w-full mx-auto">
        ...
        <section className="mb-16 page-break">
          ...
          <div className="overflow-x-auto">
            <table className="w-[60%] text-sm print:text-xs border border-gray-300">
              <thead className="[&>tr>th]:align-top">
                <tr>
                  ...
                  <th className="border px-3 py-2 w-16 text-left">
                    {LABELS.antisocial}
                  </th>
                  <th className="border px-3 py-2 w-16 text-left">
                    {LABELS.common}
        ...
        <section className="mb-16 page-break">
          ...
          <div className="overflow-x-auto">
            <table className="w-[85%] text-sm print:text-xs border border-gray-300">
              <thead className="[&>tr>th]:align-top">
                <tr>
                  <th className="border px-3 py-2 w-20 text-left">
                    {LABELS.client}
