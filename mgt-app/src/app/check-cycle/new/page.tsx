  ...
  return (
    <main className="flex justify-center items-start pt-16 min-h-screen bg-gray-50">
      <div className="w-full max-w-3xl bg-white rounded-xl shadow-lg p-8 border border-gray-100">
        <h1 className="text-xl font-bold mb-6">Add New Cycle</h1>
        <form action={createCycle} className="space-y-6">
          <div>
            <label className="block mb-1 font-medium">Name</label>
            <input name="name" type="text" required className="w-full border rounded px-3 py-2" placeholder="e.g. 2025年度 第1期" />
          </div>
          ...
          <div className="flex items-center gap-2">
            <input name="isActive" type="checkbox" id="isActive" className="h-4 w-4" />
            <label htmlFor="isActive" className="text-sm">Active</label>
          </div>
          <div className="flex gap-4 justify-end">
            <Button type="submit" className="bg-slate-700 hover:bg-slate-800 text-white">Register</Button>
